...
import { autoColorObjects, typeColorObjects, colorStr2Hex, colorAlpha } from './color-utils';
...
export default Kapsule({
  ...
  props: {
    ...
    nodeColorByType: { onChange(_, state) { state.sceneNeedsRepopulating = true } },
  ...
  update(state) {
    ...
    if (state.sceneNeedsRepopulating) {
      ...
      //==================== add-begin:190620 ====================
      // 根据节点类型显示颜色
      else if (state.nodeColorByType !== null) {
        typeColorObjects(state.graphData.nodes, state.nodeColorByType, state.nodeColor);
      }
      //===================== add-end:190620 =====================
